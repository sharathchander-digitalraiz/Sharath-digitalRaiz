...
exports.circle_sat_owner_type_attendance = async (req, res) => {
      ...
      zones_details.map(async (val) => {
        ...
        await Promise.all(
          circles_details.map(async (cir_val, index) => {
            ...
            let vehicle_cir_count_ghmc = await Vehicles_attendance.find({
              circles_id: ObjectId(cir_val._id),
              date: formatted_date,
              vehicle_type: {
                $in: ["GHMC Swatch Auto", "Private Swatch Auto"],
            ...
            let vehicle_cir_present_ghmc = await Vehicles_attendance.find({
              circles_id: ObjectId(cir_val._id),
              date: formatted_date,
              vehicle_type: {
                $in: ["GHMC Swatch Auto", "Private Swatch Auto"],
            ...
            let vehicle_cir_count_private = await Vehicles_attendance.find({
              circles_id: ObjectId(cir_val._id),
              date: formatted_date,
              vehicle_type: {
                $in: ["GHMC Swatch Auto", "Private Swatch Auto"],
            ...
            let vehicle_cir_present_private = await Vehicles_attendance.find({
              circles_id: ObjectId(cir_val._id),
              date: formatted_date,
              vehicle_type: {
                $in: ["GHMC Swatch Auto", "Private Swatch Auto"],
            ...
            let total_veh_present = await Vehicles_attendance.find({
              circles_id: ObjectId(cir_val._id),
              date: formatted_date,
              vehicle_type: {
                $in: ["GHMC Swatch Auto", "Private Swatch Auto"],
            ...
            let total_veh_abs = await Vehicles_attendance.find({
              circles_id: ObjectId(cir_val._id),
              date: formatted_date,
              vehicle_type: {
                $in: ["GHMC Swatch Auto", "Private Swatch Auto"],
