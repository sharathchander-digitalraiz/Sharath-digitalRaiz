...
exports.validatetoilets = [
    ...
    check("toilet_name")
    .notEmpty()
    .withMessage('The toilet name field is required'),
  
    check("existing_disposal")
    .notEmpty()
    .withMessage('The existing disposal is required'),
    check("quality_of_waste")
    .notEmpty()
    .withMessage('The quality of waste field is required'),
...
exports.isRequestvalidatetoilets = (req, res, next) => 
{
