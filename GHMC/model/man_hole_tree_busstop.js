...
const Manhole_treebuss_Schema = new mongoose.Schema({
    date: 
	{ 
        type: String, 
        required: true, 
...
Manhole_treebuss_Schema.index({ place: '2dsphere' });   
module.exports = mongoose.model('man_hole_tree_busstop', Manhole_treebuss_Schema);   